				...
				<!-- Main -->
					<div id="main">
						<div class="inner">
							...
							<p>제가 만든 챗봇과 깊은 대화는 할 순 없어요. "안녕", "뭐해" 등 텍스트를 입력하거나 음성인식을 통해 지정된 답변만 출력합니다. 하지만 특별한 점이 있다면 '스테이블 디퓨전'을 통해 '외형'을 얻었다는 점입니다.</p>
							<br>
							<p><b>Q. 외형? 그것에 대해 설명해주세요</b></p>
							<p>처음엔 'D-ID' 사의 스테이블 디퓨전 API를 사용하려고 했어요. 하지만 고비용에 느린 영상 변환 속도 등 실시간 서비스엔 어울리지 않았습니다. 그래서 직접 챗봇의 외형 출력 엔진을 자바스크립트로 완성하기로 했습니다.</p>
							<br>
							<p><b>Q. 쉽지 않았을텐데요</b></p>
							<p>네, 관련 외국 사이트를 정말 많이 방문했어요. 외국 분들도 해당 이슈에 대해 고민이 많으시더라고요.</p>
							<br>
							<p><b>Q. 챗봇의 외형과 음성에 관심이 많으신 이유가 있으신가요?</b></p>
							<P>'chatGPT' 를 처음 사용하면서 느낀 감정은 "사람같다" 이었습니다. 하지만 오래 사용하다 보니 '검색엔진' 과 같다는 생각이 들더군요. 그 부분을 매울 수 있는 것이 외형과 음성이라고 생각했습니다. 외형과 음성을 갖는 것만으로 사람들은 심리적으로 챗봇을 '사람'처럼 생각하게 됩니다.</P>
							<br>
							<p><b>Q. 앞으로 목표를 말씀해주세요</b></p>
							<P>우선 외형적으로 스테이블 디퓨전 출력 영상이 끊기지 않도록 보강하는게 첫번째 목표이구요, 음성으로는 챗봇이 답변하려는 문장의 단어를 모두 파악하고 문단마다 등급을 매겨 음을 길게 끌거나 강한 악센트를 주는 등 판단할 수 있도록 인공지능 기술을 활용하여 가장 자연스러운 '사람 음성'으로 말할 수 있도록 만드는 것이 제 목표입니다.</P>
							<p><b>(2023/07/26)</b></p>
						</div>
					</div>
